...
const bundleDropModule = sdk.getBundleDropModule("0x5C36c5F58D5E73B39A6a14b97b66225050BC00D7")
    ...
    return bundleDropModule
      ...
      .then((balance) => {
        if (balance.gt(0)) {
          ...
          console.log("⭐️ this user has an nft membership")
        } else {
